  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="input-group"><span class="input-group-addon"><span class="glyphicon glyphicon-info-sign" data-content="This is the publicly accessible IP or Hostname of your TacoNET application instance." data-placement="right" data-container="#addPeerModal" data-trigger="hover" data-original-title="" title=""></span> Your External Hostname or IP: </span><input maxlength="32" id="addpeermyhostname" type="text" class="form-control" placeholder="Your External Hostname">
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      ...
      <div class="input-group">
        <span class="input-group-addon"><span data-trigger="hover" data-container="body" data-placement="right" data-content="A unique nickname that you wish to be identified as on your personal TacoNET" class="glyphicon glyphicon-info-sign"></span><span class="iga-fixed-width">Your Nickname</span></span>
      ...
      <div class="input-group"><span class="input-group-addon"><span data-trigger="hover" data-container="body" data-placement="right" data-content="The IP address that the TacoNET application server will bind to. If you are unaware of what that means, it is best to leave it as the default of '0.0.0.0'" class="glyphicon glyphicon-info-sign"></span><span class="iga-fixed-width">Application IP</span></span>
      ...
      <div class="input-group"><span class="input-group-addon"><span data-trigger="hover" data-container="body" data-placement="right" data-content="The PORT that the TacoNET web server will bind to. If you are unaware of what that means, it is best to leave it as the default of '9002'. This port will typically NOT need be public accessible. This is the port you'll need to use to access TacoNET via your web browser." class="glyphicon glyphicon-info-sign"></span><span class="iga-fixed-width">Web Interface Port</span></span>
      ...
      <div class="input-group"><span class="input-group-addon"><span data-trigger="hover" data-container="body" data-placement="right" data-content="This is the limit TacoNET will attempt to respect when downloading content. Since ZeroMQ is a bit of socket magic, TacoNET will ATTEMPT to respect this limit." class="glyphicon glyphicon-info-sign"></span><span class="iga-fixed-width">Download Limit in KB/s</span></span>
      ...
      <div class="input-group"><span class="input-group-addon"><span data-trigger="hover" data-container="body" data-placement="right" data-content="This is the limit TacoNET will attempt to respect when uploading content. Since ZeroMQ is a bit of socket magic, TacoNET will ATTEMPT to respect this limit." class="glyphicon glyphicon-info-sign"></span><span class="iga-fixed-width">Upload Limit in KB/s</span></span>
      <input autocomplete="off" id="setting-uplimit" type="text" class="form-control" value="{{local_settings_copy["Upload Limit"]}}"></div>

      <div class="input-group"><span class="input-group-addon"><span data-trigger="hover" data-container="body" data-placement="right" data-content="The location your want to store your public and private certificates for use with your personal TacoNET. If you are unaware of publickey cryptography concepts, it's best to just leave this the default." class="glyphicon glyphicon-info-sign"></span><span class="iga-fixed-width">TacoNET Certificate Store</span></span>
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-md-8">
                ...
                <div class="input-group"><span class="input-group-addon">Hostname or IP</span><input autocomplete="off" type="text" class="form-control peerhost" placeholder="External Hostname" value=""><span class="input-group-addon">Dynamic? <input class='peerdynamic' type="checkbox"></input></span></div>
